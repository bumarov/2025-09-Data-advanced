...
@ResourceRole(name = "Developer role", code = DeveloperRole.CODE, scope = "UI")
public interface DeveloperRole extends UiMinimalRole {
    ...
    @EntityAttributePolicy(entityClass = Project.class, attributes = {"id", "name", "status", "startDate", "endDate", "manager", "participants", "projectLabels", "roadmap", "deletedBy", "deletedDate", "totalEstimatedEfforts", "ownerId", "owner"}, action = EntityAttributePolicyAction.VIEW)
