...
public class TimeEntry {
    ...
    @NotNull
    @Positive(message = "Spent time: ${validatedValue} must pe positive")
    ...
    @Lob
    @Length(message = "{msg://com.company.jmixpmdata.entity/TimeEntry.description.validation.Length}", min = 10)
